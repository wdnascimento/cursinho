...
class TableCodeSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        // //  PAYMENT STATUS
        $table->create(['pai' => '11','item' => '0','valor' => '0','descricao' => 'PAYMENT STATUS']);
        $table->create(['pai' => '11','item' => '1','valor' => '1','descricao' => 'AGUARDANDO PAGAMENTO']);
        $table->create(['pai' => '10','item' => '2','valor' => '2','descricao' => 'PAGO - INSCRIÇÃO CONFIRMADA']);
